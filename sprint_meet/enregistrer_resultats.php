...
// Vérifier si l'ID de la course est bien présent
$course_id = $_POST['course_id'] ?? null;
if (!$course_id) {
    die("Erreur : Course non spécifiée.");
}

// Vérifier si des résultats sont soumis
...
try {
    ...
    $pdo->commit();
    header("Location: dashboard_arbitre.php?message=Résultats ajoutés avec succès");
    exit;
