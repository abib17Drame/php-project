...
$nbre_athletes = "SELECT COUNT(*) as total FROM users WHERE role='athlete'";
$res_nbre_athlete = mysqli_query($conn, $nbre_athletes);
$l_athlete = mysqli_fetch_assoc($res_nbre_athlete);
$totalAthletes = $l_athlete['total'];

// Récupération du nombre de courses
$nbre_course = "SELECT COUNT(*) as total FROM courses";
$res_nbre_courses = mysqli_query($conn, $nbre_course);
$l_courses = mysqli_fetch_assoc($res_nbre_courses);
$totalCourses = $l_courses['total'];

// Récupération du nombre d'arbitres
$nbre_arbitres = "SELECT COUNT(*) as total FROM users WHERE role='arbitre'";
$res_nbre_arbitre = mysqli_query($conn, $nbre_arbitres);
$l_arbitres = mysqli_fetch_assoc($res_nbre_arbitre);
$totalArbitres = $l_arbitres['total'];

// Récupération du nombre de résultat
$res = "SELECT COUNT(*) as total FROM inscriptions WHERE temps_realise IS NOT NULL";
$res_res = mysqli_query($conn, $res);
$l_res = mysqli_fetch_assoc($res_res);
$totalres = $l_res['total'];
?>
<!DOCTYPE html>
<html lang="fr">
<head>
